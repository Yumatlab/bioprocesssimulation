function new_app = Escherichia_coli_Initialization(app)
...
app.a.qS1pXmax = (app.p.my1opt+app.a.mySm)/app.p.yXpS1gr; % Maximum specific glucose uptake rate [1/h]
app.a.qS2pXmax = (app.p.my2opt+app.a.mySm)/app.p.yXpS2gr; % Maximum specific glycerol uptake rate [1/h]
app.a.qS3pXmax = (app.p.my3opt+app.a.mySm)/app.p.yXpS3gr; % Maximum specific acetate uptake rate [1/h]
...
% Index of reservoir
app.a.numReservoir = 1;

% Check if project was started for the first time
if app.nxtidx == 1
    ...
    app.v.VR1in(1) = 0;
    app.v.FR1(1) = 0;
    app.v.QS1in(1) = (app.v.FR1(end)*app.p.cS1R1)/app.v.VL(end);
