function [dy] = Escherichia_ODE_Luttmann(qXpX,Din,cS1R1,qS1pX,cS2R1,qS2pX,cP1R1,qP1pX,MP1,cOT1,cOT2,cOR1,OTR,OUR,cOL100,TMpO2,DT1,CAcT1tot,qAcpX,MAc,DT2,CAlT2tot,qAlpX,AlTR,MAl,DR1,CCR1tot,CCT1tot,CCT2tot,CTR,CER,MCO2,pHL,TMpH,TMxO2,xOG,TMxCO2,xCG,lamdaF,qhpX,lamdaAF,AAFin,tauD,DD,thetaTc,tauDL,thetaU,tauDU,tauL,tauLD,tauLU,QdotM,QdotSt,CL,t,y)
...
dy(4) = DR1*cP1R1-Din*y(4)+qP1pX*y(1);
